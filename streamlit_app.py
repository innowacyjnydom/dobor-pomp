...
DANE_POMP = {
    ...
    "Mitsubishi (Ecodan R290)": {
        "ECODAN R290 5kW": {"35": {"pts": [[-25.0, 3.2], [-20.0, 3.8], [-15.0, 4.2], [-10.0, 4.9], [-7.0, 5.2], [2.0, 5.8], [7.0, 6.2]]}, "55": {"pts": [[-15.0, 3.2], [-10.0, 3.8], [-7.0, 4.5], [2.0, 4.6], [7.0, 5.5]], "limit": -15}},
        "ECODAN R290 6kW": {"35": {"pts": [[-25.0, 4.1], [-20.0, 4.8], [-15.0, 5.4], [-10.0, 6.2], [-7.0, 6.2], [2.0, 6.8], [7.0, 7.2]]}, "55": {"pts": [[-25.0, 3.2], [-20.0, 3.7], [-15.0, 4.0], [-10.0, 4.7], [-7.0, 5.4], [2.0, 6.0], [7.0, 6.8]]}},
        "ECODAN R290 8kW": {"35": {"pts": [[-25.0, 5.1], [-20.0, 6.3], [-15.0, 7.2], [-10.0, 8.1], [-7.0, 8.1], [2.0, 8.1], [7.0, 8.1]]}, "55": {"pts": [[-25.0, 4.5], [-20.0, 5.4], [-15.0, 6.1], [-10.0, 6.6], [-7.0, 7.5], [2.0, 8.1], [7.0, 8.1]]}}
    },
    "LG (R32 Mono)": {
